...
export default function DonationChart() {
  ...
  return (
    <section
      id="dashboard"
      className="relative mb-12 bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-700 overflow-hidden"
    >
      ...
      <div className="relative bg-gray-900/50 rounded-xl shadow-inner p-6 transition-transform duration-300 hover:scale-[1.01] border border-gray-600">
        {donations.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-48 text-gray-400">
            <svg
              className="w-16 h-16 mb-3 text-gray-500"
              fill="none"
              stroke="currentColor"
              strokeWidth="1.5"
              viewBox="0 0 24 24"
            ...
            <p className="text-sm text-gray-500 mt-1">Start making an impact today!</p>
          </div>
        ) : (
